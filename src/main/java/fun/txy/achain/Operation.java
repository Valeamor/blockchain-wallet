...
import static fun.txy.achain.Operation.OperationType.*;
...
public class Operation {
  ...
  public static Operation createIMessage(String remark) {
    ...
    if (remarkBytes.length > 40) {
      throw new IllegalArgumentException("ACT转账备注过长");
    }
    Operation operation = new Operation();
  ...
  public static Operation createCallContract(
    ...
    Asset transactionFee = new Asset(ActTransaction.requiredFees);
